    		...
    		<div class="row">
    			<div class="col-md-12">
				    <div class="box box-primary">
				            ...
				            <!-- /.box-header -->
				            <!-- form start -->
				            <form role="form" onsubmit="return confirmPassword()" method="post" action="<?=base_url('admin/profileEditData')?>">
				              ...
				              <div class="box-body">
				                ...
				                <div class="form-group" id="p1">
				                  ...
				                  <input type="password" class="form-control" id="user_password" name="user_password" placeholder="Password" value="" onblur="removeClass()">
				                </div>

				                <div class="form-group" id="p2">
				                  <label for="cnf_password">Confirm Password</label>
				                  <input type="password" class="form-control" id="cnf_password" name="cnf_password" placeholder="Password" value="" onblur="removeClass()">
				                </div>
