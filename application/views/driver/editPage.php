    		...
    		<div class="row">
    			<div class="col-md-12">
				    <div class="box box-primary">
				            ...
				            <!-- /.box-header -->
				            <!-- form start -->
				            <form role="form" onsubmit="return confirmPassword()" method="post" action="<?=base_url('admin/DriverEditData')?>">
				              <div class="box-body">
				                ...
				                <div class="form-group">
				                  ...
				                  <input type="email" class="form-control" id="user_email" name="user_email" placeholder="Enter Email" required="" value="<?=$editData[0]->user_email?>">
				                </div>
				                ...
				                <div class="form-group">
				                  <label for="user_licence_number">User Licence</label>
				                  <input type="text" class="form-control" id="user_licence_number" name="user_licence_number" placeholder="Enter Licence" value="<?=$editData[0]->user_licence_number?>" required="">
				                </div>

				                <div class="form-group">
				                  <label for="user_DOB">User DOB</label>
				                  <input class="form-control" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask="" type="text" id="user_DOB" name="user_DOB" value="<?=$editData[0]->user_DOB?>" required="">
				                </div>

				                <div class="form-group">
				                  <label for="user_address">User Address</label>
				                  <textarea class="form-control" id="user_address" name="user_address" placeholder="Enter Address" required=""><?=$editData[0]->user_address?></textarea>
				                </div>
				                
				                <div class="form-group">
				                  <label for="user_mobile">User State</label>
				                  <input type="text" class="form-control" id="user_state" name="user_state" value="<?=$editData[0]->user_state?>" placeholder="Enter State" required="">
				                </div>
				                <div class="form-group">
				                  <label for="user_mobile">User City</label>
				                  <input type="text" class="form-control" id="user_city" name="user_city" value="<?=$editData[0]->user_city?>" placeholder="Enter City" required="">
				                </div>
				                <div class="form-group">
				                  <label for="user_mobile">User Post Code</label>
				                  <input type="text" class="form-control" id="user_post_code" name="user_post_code" value="<?=$editData[0]->user_post_code?>" placeholder="Enter Post Code" required="">
				                </div>
