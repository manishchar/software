				    ...
				    <div class="box box-primary box-body">
                      ...
                      <div class="col-md-6">
                       <div class="form-group">
                          <label for="add_name">Select User</label>
<select class="form-control select" name="user_login_id" id="user_login_id" required="">
                            <option value="">SELECT</option>
                            <?php foreach ($userList as $row) { ?>
      <option value="<?=$row->user_login_id?>" <?php if($row->user_login_id==$result[0]->user_login_id){echo "selected"; } ?> ><?=$row->user_full_name?></option>
                            <?php } ?>
                    ...
                    <?php $times=unserialize($result[0]->timeTable);
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                          ...
                          <!-- <img class="img-responsive" id="img1src" src="<?=base_url('resources/coupon/').$result[0]->smallLogo?>" > -->
                        ...
                        <div class="col-md-6">
                          ...
                          <!-- <img class="img-responsive" src="<?=base_url('resources/coupon/').$result[0]->bannerLogo?>" id="img3src" > -->
  ...
  <input id="search1" class="controls form-control" type="text" placeholder="Search Box" name="branch_address" value="<?=$result[0]->branch_address?>" required>
                    ...
                    <div id="map1" class="map"></div>
                          ...
                          <div class="col-md-12" style="padding: 0px">
                            <div class="col-md-6">
                              <div class="form-group"><label>lat :</label><input type="text" class="form-control" name="lat" id="lat_01"  value="<?=$result[0]->lat?>" required=""></div></div>
                            <div class="col-md-6"><div class="form-group"><label>lng :</label><input type="text" class="form-control" name="lng" id="lng1" value="<?=$result[0]->lng?>" required=""></div></div>
                          </div>
